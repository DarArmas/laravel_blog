<div class="form-group row">
    <label for="titulo" class="col-sm-2 text-right control-label requerido">Titulo</label>
    <div class="col-sm-8">
...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        <input type="file" name="imagen" id="imagen" data-initial-preview="{{"http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=Imagen+Post"}}" accept="image/*"/>
    </div>
</div>
