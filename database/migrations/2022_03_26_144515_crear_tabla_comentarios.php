...
class CrearTablaComentarios extends Migration
{
    ...
    public function up()
    {
        Schema::create('comentarios', function (Blueprint $table) {
            ...
            $table->foreign('comentarios_id', 'fk_comentario_comentario')->references('id')->on('comentarios')->onDelete('cascade')->onUpdate('restrict'); //relacion interna
            $table->text('contenido');
            $table->boolean('estado')->default(0); //para que el usuario sea verificado
            $table->timestamps();
        });
    }
